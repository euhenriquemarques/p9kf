                ...
                >
                  {despesasLista.map((tipo, index) => (
                    <MenuItem key={index} value={tipo.id}>
                      <strong>Parcela:</strong> {tipo.parcela}/{tipo.parcelaTotais}  |   
                      <strong>Valor:</strong> {formatCurrency(tipo.valorParcela)}  | 
                      <strong>Venc:</strong> {formatData(dayjs(tipo.dataVencimentoParcela))} -{" "}
                      {tipo.descricao}
                    </MenuItem>
                  ))}
                </Select>
